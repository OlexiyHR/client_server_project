...
public class ManageGoodsHandler implements HttpHandler {
    @Override
    public void handle(HttpExchange exchange) throws IOException {
        ...
        if ("GET".equals(exchange.getRequestMethod())) {
            ...
            if (pathParts.length == 3){
                ...
                response = Files.readAllBytes(Paths.get("src/pages/manage-goods.html"));
            }
    ...
    private byte[] generateManageGroupsPage(HttpExchange exchange, String message) throws IOException {
        ...
        String htmlTemplate = new String(Files.readAllBytes(Paths.get("src/pages/manage-goods.html")), StandardCharsets.UTF_8);
