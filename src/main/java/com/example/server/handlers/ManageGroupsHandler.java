...
public class ManageGroupsHandler implements HttpHandler {
    @Override
    public void handle(HttpExchange exchange) throws IOException {
        ...
        if ("GET".equals(exchange.getRequestMethod())) {
            ...
            if (pathParts.length == 3){
                ...
                response = Files.readAllBytes(Paths.get("src/pages/manage-groups.html"));
            }
    ...
    private byte[] generateManageGroupsPage(HttpExchange exchange, String message) throws IOException {
        ...
        String htmlTemplate = new String(Files.readAllBytes(Paths.get("src/pages/manage-groups.html")), StandardCharsets.UTF_8);
